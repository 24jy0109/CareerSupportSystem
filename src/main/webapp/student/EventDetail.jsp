								...
								<c:choose>
									...
									<c:when test="${event.joinAvailability == null}">
										...
										<c:if
											...
											<button type="button"
												onclick="location.href='event?command=EventJoin&eventId=${event.event.eventId}'">参加</button>
			
										
											<button type="button"
												onclick="location.href='eevent?command=EventNotJoin&eventId=${event.event.eventId}'"
